...
In english we usually make nouns plural by adding an ***s*** to the end. (garden - garden*s*); (house - hous*es*), although we do have some nouns which are irregular and do not follow this pattern (mouse - *mice*); (child - *children*)

To form the plural in spanish, add ***s*** to most nouns ending in a vowel ***(a,e,i,o,u)*** which  does not have an accent. 
...
To form plural to singular nouns ending with a constant *(any letter than a vovel)* add ***es***


+ **el profesor** *the (male) professor*
+ **los profesor*es*** *the (male) professors*
+ **la ciudad ** *the city*
+ **las ciudad*es*** *the cities*


The words ending in ***S*** which have an unstressed final vovel do not change in plural 

+ **el paraguas** *the umbrella*
+ **los paragua*s*** *the umbrellas*
+ **el lunes** *monday*
+ **los lunes** *mondays*

Most singlular nouns ending in an accented vovel add ***s*** in the plural, but those ending in the accented i (í) and u (ú) usually have two possibile plurals with ***es*** and ***s***

+ **el café** *the cafe*
+ **los café*s***  *the cafes*
+ **el sofá** *the sofa*
+ **los sofá*s*** *the sofas*
+ **el jabalí** *the boar*
+ **los Jabalí*es*** or **los Jabalí*s*** *the boars*

##### Spelling changes with Plural ending in ***es***
...
Singular nouns of more than one syllable which end in ***en*** and dont already have an accent, add one in the plural

+ **el examen** *the exam*
+ **los ex*á*menes** *the exams*
+ **el joven** *the youth*
...
Few words relating to the clothing that are plural in english can be singular in spanish 

+ **una braga** *a pair of nickers*
...
Take a [Noun Test](https://www.e-spanyol.com/spanish-tests/test-01-noun-gender-el-la.php)

Take a [singular/plural test](https://spanish.tolearnfree.com/free-spanish-lessons/free-spanish-exercise-12379.php) 
...
The indefinite article: a or an in English, whose plural is some or any (or no word at all). 
This is used to refer to something unspecific, or that you do not really know about.
...
In english, there is only **one** definite article: *the*. In Spanish, you have to choose between four definite articles ***el, la, los, las***. Which one you would choose depends on the noun which follows. 

In Spanish all nouns (including words for things) are either masculine or feminine - this is called their *gender*. And just as in English, they can also be singular or plural. You must bear in mind when deciding which spanish word to use for ***the***
